...
public class JdbcProductRepository implements ProductRepository {
    ...
    private static final RowMapper<Product> productRowMapper = (resultSet, i) -> {
        ...
        var created_at = toLocalDateTime(resultSet.getTimestamp("created_at"));
        var updated_at = toLocalDateTime(resultSet.getTimestamp("updated_at"));
        return new Product(productId, productName, category, price, description, created_at, updated_at);
    };
